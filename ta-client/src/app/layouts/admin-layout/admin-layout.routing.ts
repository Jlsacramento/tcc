...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'mesas-solicitadas',        component: MesasSolicitadasComponent },
    { path: 'mesas-atendimento',        component: MesasAtendimentoComponent },
    { path: 'mesas-livres',        component: MesasLivresComponent },
